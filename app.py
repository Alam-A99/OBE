...
# Upload multi-file
# =========================================================
st.subheader("📥 Upload Nilai — multi file Mata Kuliah")
...
selected_cpl = st.sidebar.multiselect(
    "Pilih CPL",
    cpl_list,
    default=cpl_list  # default: semua 14 CPL terpilih
)
...
with tabs[0]:
    ...
    METRICS_PER_ROW = 7
    for row_start in range(0, len(selected_cpl), METRICS_PER_ROW):
        row_cpls = selected_cpl[row_start:row_start + METRICS_PER_ROW]
